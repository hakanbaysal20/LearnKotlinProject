...
class DatabaseAccess(context:Context) : SQLiteOpenHelper(context,"filmler.sqlite",null,1) {
    // cursor tablolardaki verilere erişen bir nesne. ilk olarak null tanımladık.
